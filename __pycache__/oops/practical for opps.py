...
try:
 ...
 #Ask the user to enter a file name. Try opening and reading it.Use finally to print "File operation finished." even if an error occurs.
...
#10 Write a program that simulates a bank withdrawal. If the withdrawal amount is greater than the balance, raise a custom ValueError saying "Insufficient balance!".
balance = 5000
